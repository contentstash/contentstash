...
class MigrationHelperOld
{
     ...
     */
    public static function generateMigrationFile(string $model, array $attributes, string $action = 'create'): array
    {
        // load stub
    ...
    protected static function preProcessAttributeMigration(array $attribute): array
    {
        ...
        $migration = $attributeType->getMigrationDefinition();
